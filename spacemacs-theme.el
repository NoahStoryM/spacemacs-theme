...
;; Copyright (C) 2015-2023 Nasser Alshammari
...
;;;;; company
     `(company-echo-theme ((,class (:background ,base :foreground ,bg1))))
     `(company-preview ((,class (:background ,ttip-bg :foreground ,ttip))))
     `(company-preview-theme ((,class (:background ,ttip-bg :foreground ,base))))
     ...
     `(company-tooltip-theme ((,class (:background ,ttip-bg :foreground ,keyword))))
     `(company-tooltip-theme-selection ((,class (:foreground ,keyword))))
